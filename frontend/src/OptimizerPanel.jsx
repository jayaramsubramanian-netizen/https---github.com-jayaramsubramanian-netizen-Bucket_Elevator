...
const C = {
  hi: "#243247",    border2: "#ffffff1e",  muted: "#64748b",  muted2: "#94a3b8",
  blue: "#3b82f6",  green: "#10b981",      amber: "#f59e0b",  teal: "#14b8a6",
  red: "#ef4444",   text: "#f1f5f9",
};
...
export default function OptimizerPanel({ inputs, onApply }) {
  ...
  return (
    <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      {results && best && (
        <>
          <div style={{ padding: "10px 12px", background: C.hi, borderRadius: "var(--r-md)", border: `1px solid ${C.border2}`, fontSize: 11 }}>
